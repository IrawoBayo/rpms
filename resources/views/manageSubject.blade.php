...
<div class="row">
	<div class="col-lg-12">
		<section class="panel panel-default">
			...
			<form action="{{ route('manageSubject') }}" class="form-horizontal" id="frm-create-subject" method="POST">
				{{ csrf_field() }}
						...
						@foreach($subjects as $subject)
							<tbody>
								<tr>
									...
									<td>
										<a href="{{ url('/editSubject/'.$subject->subject_id) }}"><button class="btn btn-info">Edit</button></a>
										<a href="{{ url('/deleteSubject/'.$subject->subject_id) }}"><button class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this subject?')">Delete</button></a>
									</td>
								</tr>
							</tbody>
						@endforeach
