		...
		<section class="panel panel-default">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body" id="add-class-body">
					<a href="{{ url('/ss-listStudent') }}"><button class="btn btn-warning pull-right">View All</button></a>
					<a href="{{ url('/ss-editStudent/'.$student->id) }}"><button class="btn btn-info pull-right">Edit</button></a>
