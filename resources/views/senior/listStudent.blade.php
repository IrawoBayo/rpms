							...
							<tbody>
								...
								@foreach($students as $student)
									<tr>
										...
										<td>
										<a href="{{ url('/ss-viewStudent/'.$student->id) }}"><button class="btn btn-warning">View</button></a>
										<a href="{{ url('/ss-editStudent/'.$student->id) }}"><button class="btn btn-info">Edit</button></a>
										<a href="{{ url('/ss-deleteStudent/'.$student->id) }}"><button onclick="return confirm('Are you sure you want to delete this student?')" class="btn btn-danger">Delete</button></a>
									</td>
									</tr>
								@endforeach
							</tbody>
