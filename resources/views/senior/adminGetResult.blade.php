                        ...
                        <tbody>
                            ...
                            @foreach($results as $result)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/ss-adminDeleteResult/'.$result->id) }}"><button class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this result?')">Delete</button></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
