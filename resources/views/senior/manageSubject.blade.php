...
<div class="row">
	<div class="col-lg-12">
		<section class="panel panel-default">
			...
			<form action="{{ route('ss-manageSubject') }}" class="form-horizontal" id="frm-create-subject" method="POST">
				{{ csrf_field() }}
						...
						@foreach($subjects as $subject)
							<tbody>
								<tr>
									...
									<td>
										<a href="{{ url('/ss-editSubject/'.$subject->id) }}"><button class="btn btn-info">Edit</button></a>
										<a href="{{ url('/ss-deleteSubject/'.$subject->id) }}"><button onclick="return confirm('Are you sure you want to delete this Subject?')" class="btn btn-danger">Delete</button></a>
									</td>
								</tr>
							</tbody>
						@endforeach
