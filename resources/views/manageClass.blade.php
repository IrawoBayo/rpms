...
<div class="row">
	<div class="col-lg-12">
		<section class="panel panel-default">
			...
			<form action="{{ route('manageClass') }}" class="form-horizontal" id="frm-create-subject" method="POST">
				{{ csrf_field() }}
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							...
							<div class="input-group">
								<input type="text" name="class_name" id="class_name" class="form-control" placeholder="JSS 1, SSS 2">
							...
							<tbody>
								@foreach($classes as $class)
									<tr>
										...
										<td>
											<a href="{{ url('/editClass/'.$class->class_id) }}"><button class="btn btn-info">Edit</button></a>
											<a href="{{ url('/deleteClass/'.$class->class_id) }}"><button class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this class?')">Delete</button></a>
										</td>
									</tr>
								@endforeach
							</tbody>
