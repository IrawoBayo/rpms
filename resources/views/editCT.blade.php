...
<div class="row">
	<div class="col-lg-12">
		<section class="panel panel-default">
			...
			<form action="{{ url('/editCT/'.$ct->id) }}" class="form-horizontal" id="frm-create-subject" method="POST">
				{{ csrf_field() }}
						...
						<div class="col-sm-4">
							...
							<div class="">
								<select class="form-control" name="class_id" id="class_id">
									...
									<option value="{{ $c->class_id }}" @if($c->class_id == $ct->class_id) selected @endif>{{ $c->class_name }}{{ $c->section }}</option>
									@endforeach	
