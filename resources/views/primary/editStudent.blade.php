...
<div class="row">
	<div class="col-lg-12">
		<section class="panel panel-default" style="overflow-y: auto; height: 500px;">
			...
			<form action="{{ url('/pri-editStudent/'.$student->id) }}" class="form-horizontal" id="frm-create-subject" method="POST" enctype="multipart/form-data">
						...
						<div class="col-sm-2">
							...
							<div class="input-group">
								...
								@foreach($classes as $Key =>$c)
									<option value="{{ $c->id }}" @if($c->id == $student->class_id) selected @endif>{{ $c->class_name }}{{ $c->section }}</option>
									@endforeach	
