...
<div class="row">
	<div class="col-lg-12">
		<section class="panel panel-default">
			...
			<form action="{{ route('pri-manageResult') }}" class="form-horizontal" id="frm-create-subject" method="POST">
				{{ csrf_field() }}
							...
							@foreach($results as $result)
								<tr>
									...
									<td>
										...
										<a href="{{ url('/pri-deleteResult/'.$result->id) }}"><button onclick="return confirm('Are you sure you want to delete this result?')" class="btn btn-danger">Delete</button></a>
									</td>
								</tr>
