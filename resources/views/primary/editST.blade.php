...
<div class="row">
	<div class="col-lg-12">
		<section class="panel panel-default">
			...
			<form action="{{ url('/pri-editST/'.$st->id) }}" class="form-horizontal" id="frm-create-subject" method="POST">
				{{ csrf_field() }}
						...
						<div class="col-sm-4">
							...
							<div class="">
								<select class="form-control" name="subject_id" id="subject_id">
									...
									<option value="{{ $c->id }}" @if($c->id  == $st->subject_id) selected @endif>{{ $c->subject_name }}</option>
									@endforeach	
