...
<div class="row">
	<div class="col-lg-12">
		<section class="panel panel-default">
			...
			<form action="{{ route('pri-manageClass') }}" class="form-horizontal" id="frm-create-subject" method="POST">
				{{ csrf_field() }}
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							...
							<div class="input-group">
								<input type="text" name="class_name" id="class_name" class="form-control" placeholder="Primary 1">
							...
							<tbody>
								@foreach($classes as $class)
									<tr>
										...
										<td>
											<a href="{{ url('/pri-editClass/'.$class->id) }}"><button class="btn btn-info">Edit</button></a>
											<a href="{{ url('/pri-deleteClass/'.$class->id) }}"><button onclick="return confirm('Are you sure you want to delete this Class?')" class="btn btn-danger">Delete</button></a>
										</td>
									</tr>
								@endforeach
							</tbody>
