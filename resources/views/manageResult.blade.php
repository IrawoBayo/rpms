...
<div class="row">
	<div class="col-lg-12">
		<section class="panel panel-default">
			...
			<form action="{{ route('manageResult') }}" class="form-horizontal" id="frm-create-subject" method="POST">
				{{ csrf_field() }}
							...
							@foreach($results as $result)
								<tr>
									...
									<td>
										...
										<a href="{{ url('/deleteResult/'.$result->id) }}"><button class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this result?')">Delete</button></a>
									</td>
								</tr>
