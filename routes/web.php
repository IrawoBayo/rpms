...
Route::group(['middleware'=>['authen','roles'],'roles'=>['admin']],function(){
    ...
    Route::get('/inactiveStaff', [
    'uses' => 'SubjectController@inactive',
    'as' => 'inactiveStaff'
    ...
    Route::get('/changestatus/{id}', 'SubjectController@changestatus')->name('changestatus');
...
Route::group(['middleware'=>['authen','roles'],'roles'=>['ssAdmin']],function(){
   ...
   Route::get('/ss-inactiveStaff', [
   'uses' => 'SeniorController@getinactiveStaff',
   'as' => 'ss-inactiveStaff'
   ...
   Route::get('/sschangestatus/{id}', 'SeniorController@changestatus')->name('sschangestatus');
...
Route::group(['middleware'=>['authen','roles'],'roles'=>['priAdmin']],function(){
    ...
    Route::get('/pri-inactiveStaff', [
    'uses' => 'PrimaryController@getinactiveStaff',
    'as' => 'pri-inactiveStaff'
    ...
    Route::get('/prichangestatus/{id}', 'PrimaryController@changestatus')->name('prichangestatus');
